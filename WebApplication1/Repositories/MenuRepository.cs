    ...
    public class MenuRepository
    {
        public Menu ProcuraMenu()
        {
            ...
            Section bebidas = new Section
            {
                ...
                Products = new List<Product>
            {
                new Product { Id = 13, Title = "Refrigerante", Price = 2.49, Description = "Lata de refrigerante de cola gelada." , Ingredients = new List<string> { "Refrigerante", "Gelo" }, Thumbnail = "", Cover="" },
                new Product { Id = 14, Title = "Suco Natural", Price = 3.49, Description = "Copo de suco natural de laranja." , Ingredients = new List<string> { "Laranja" }, Thumbnail = "", Cover="" },
                new Product { Id = 15, Title = "Água Mineral", Price = 1.99, Description = "Garrafa de água mineral sem gás." , Ingredients = new List<string> { "Água" }, Thumbnail = "", Cover="" }
            }
            };
